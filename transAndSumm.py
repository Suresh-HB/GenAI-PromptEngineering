...
@Title: Python program to perform Gen AI tasks using Gemini
"""
...
def translate_email(text, chat_session):
    ...
    """
    response = chat_session.send_message(f"Translate the following text to Kannada: {text}")
    return response.text
...
def main():
    try:
        ...
        process_emails(r'C:\Users\Suresh\Desktop\pythonBl\Generative_AI\email.txt', 'processed_emails.csv', chat_session)
